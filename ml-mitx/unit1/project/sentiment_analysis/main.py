...
#accuracy = p1.classifier_accuracy(p1.pegasos, train_bow_features,test_bow_features,train_labels,test_labels,T=25,L=.01)
...
theta, theta_0 = p1.pegasos(train_bow_features, train_labels, 25, .01)
