...
def check_pegasos_single_update():
    ...
    # # Added this myself
    # feature_vector = np.array([ 0.37522729,  0.00636377, -0.34831109, -0.13444632,  0.49581178,  0.08842829,
    #                             -0.29986517, 0.3437156,  -0.2103254,  -0.05087365,])
    # label, theta, theta_0 = 1, np.array([-0.05812705,  0.05733027, -0.12975384,  0.25977794, -0.21665404, -0.430885,
    #                                      0.34590961,  0.06727298,  0.22565221,  0.22584074]), 1.7859963266076084
    # L = 0.7838970408685928
    # eta = 0.4216210099857899
    # exp_res = (np.array([-0.0389156, 0.0383822, -0.0868692, 0.1739194, -0.1450483, -0.2884743, 0.2315839, 0.0450388, 0.1510725, 0.1511987]), 1.7859963)
    # if check_tuple(
    #         ex_name, p1.pegasos_single_step_update,
    #         exp_res,
    #         feature_vector, label, L, eta, theta, theta_0):
